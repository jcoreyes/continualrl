...
class FoodEnvMedium(FoodEnvBase):
    ...
    def __init__(
        ...
        self.nonfood_objs = {obj: idx for obj, idx in self.object_to_idx.items() if
                             obj not in FOOD_VALUES}
        super().__init__(
            grid_size=32,
    ...
    def gen_her_obs(self):
        ...
        obs = {'observation': achieved_goal, 'desired_goal': self.goal_obs,
    ...
    def compute_reward(self, achieved_goal, desired_goal, info):
        assert self.her or self.skewfit, "`compute_reward` function should only be used for HER " \
										 "or skewfit"

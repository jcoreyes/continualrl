...
if __name__ == "__main__":
    ...
    3. use_gpu 
    """
    exp_prefix = 'tool-dqn-dynamism-deer-mixing'
    n_seeds = 5
    mode = 'local'
    use_gpu = False
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=64,
            validation_envs_pkl=join(get_repo_dir(), 'examples/continual/measure/dynamism/mixing/deer/validation_envs/dynamic_static_validation_envs_2020_05_21_18_42_53.pkl'),
            validation_period=5,

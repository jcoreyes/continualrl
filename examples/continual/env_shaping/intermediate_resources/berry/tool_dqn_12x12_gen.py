...
if __name__ == "__main__":
    ...
    algo_variant = dict(
        ...
        algorithm_kwargs=dict(
            ...
            batch_size=256,
            validation_envs_pkl=join(get_repo_dir(), 'examples/continual/env_shaping/intermediate_resources/berry/validation_envs/dynamic_static_validation_envs_12x12_2019_09_08_08_44_31.pkl'),

...
if __name__ == "__main__":
    """
        ...
        3. use_gpu 
        """
    exp_prefix = 'unity-food-collector-dqn-natcurr-resetfree'
    n_seeds = 3
    mode = 'ec2'
    use_gpu = False
    ...
    search_space.update(
        ...
        env_path=[
            'examples/unity/env_builds/natural_curriculum/resetfree/FCRFInit1.x86_64',
            'examples/unity/env_builds/natural_curriculum/resetfree/FCRFInit5.x86_64',
            'examples/unity/env_builds/natural_curriculum/resetfree/FCRFInit10.x86_64',
            'examples/unity/env_builds/natural_curriculum/resetfree/FCRFInit15.x86_64',
            'examples/unity/env_builds/natural_curriculum/resetfree/FCRFInit20.x86_64',
        ]
    )
